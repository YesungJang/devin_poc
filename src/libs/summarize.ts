...
import { SupportedLanguage, setMockLanguage, getMockLanguage } from './translate';
      ...
      chat: {
        completions: {
          create: (params: any) => {
            ...
            console.log('Current mock language for summary:', getMockLanguage());
            ...
            return Promise.resolve({
              choices: [{ message: { content: mockSummaries[getMockLanguage()] } }]
            });
          }
        }
      }
